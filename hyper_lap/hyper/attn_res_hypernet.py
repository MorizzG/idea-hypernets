...
class AttnResHyperNet(eqx.Module):
    ...
    def generate(
        self, input_emb: Array, with_aux: bool = False
        ...
        unet_pos_embs_flat, unet_pos_embs_shapes = AttnResHyperNet.flatten_with_def(unet_pos_embs)
        recomb_pos_embs_flat, recomb_pos_embs_shapes = AttnResHyperNet.flatten_with_def(
            recomb_pos_embs
        )
        ...
        unet_embs = AttnResHyperNet.unflatten_from_def(unet_embs_flat, unet_pos_embs_shapes)
        recomb_embs = AttnResHyperNet.unflatten_from_def(recomb_embs_flat, recomb_pos_embs_shapes)

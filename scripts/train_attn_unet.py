...
def training_step(
    ...
    def grad_fn(film_unet: AttentionUnet) -> Array:
...
def main():
    ...
    model_name = f"filmunet-{config.dataset}-{config.attn_unet.embedder_kind}"
    ...
    trainer: Trainer[AttentionUnet] = Trainer(
